...
def show_databatch_training(epoch,inputs, size=(8,8), batch=16):
    ...
    #result_impath = '/home/aminul/data3/tasnim/UNet/colon_result/training/'
    result_impath = '/home/aminul/data3/tasnim/UNet/kidney_result/training/'
...
def show_databatch_adv_training(epoch,inputs, size=(8,8), batch=16):
    ...
    imshow(out, size)
    inp = out.numpy().transpose((1, 2, 0))
    result_impath = '/home/aminul/data3/tasnim/UNet/kidney_result/adv_training/'
    plt.imsave(result_impath+str(epoch)+'_training.jpg',inp ) 
...
def show_databatch_adv_testing(epsilon,inputs, size=(8,8),  batch=16):
    ...
    imshow(out, size)
    inp = out.numpy().transpose((1, 2, 0))
    result_impath = '/home/aminul/data3/tasnim/UNet/kidney_result/adv_testing_1/'
...
def show_databatch_adv_testing_new(epsilon,inputs, size=(8,8),  batch=16):
    ...
    imshow(out, size)
    inp = out.numpy().transpose((1, 2, 0))
    result_impath = '/home/aminul/data3/tasnim/UNet/kidney_result/adv_testing_2/'
    plt.imsave(result_impath+epsilon+'_testing.jpg',inp ) 
...
def plotCurves(stats):
    ...
    plt.show()
    plt.savefig('/home/aminul/data3/tasnim/UNet/colon_result/Standard_training.jpg' )
...
def plotCurves_adv(stats):
    ...
    plt.show()
    plt.savefig('/home/aminul/data3/tasnim/UNet/colon_result/FGSM_training.jpg' )
...
def plotCurves_I_adv(stats):
    ...
    plt.show()
    plt.savefig('/home/aminul/data3/tasnim/UNet/colon_result/I_FGSM_training.jpg' )
...
def plotCurves_eps(eps_stats,eps_values ):
    ...
    plt.show()
    plt.savefig('/home/aminul/data3/tasnim/UNet/colon_result/eps_FGSM.jpg', dpi = 300 )    
def plotCurves_eps_test(eps_stats,eps_values ):
    ...
    plt.show()
    plt.savefig('/home/aminul/data3/tasnim/UNet/colon_result/eps_FGSM_test.jpg',dpi= 300 )     
